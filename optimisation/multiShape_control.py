...
if __name__ == "__main__":
	...
	# demo.draw_triangle([0, 0])

	# start = [-5, 0]
	# end = [5, 0]
	# demo.draw_line(start, end, 0.01)

	# center = [0,0]
	# demo.draw_cross(center)
	...
	for i in range(len(shape_list)):
		if shape_list[i] == "0":
			start = [center_list[i][0] - 5, center_list[i][1]]
			end = [center_list[i][0] + 5, center_list[i][1]]
			demo.draw_line(start, end, 0.01)
		elif shape_list[i] == '1':
			start = [center_list[i][0], center_list[i][1] - 5]
			end = [center_list[i][0], center_list[i][1] + 5]
